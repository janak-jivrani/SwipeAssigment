...
object Rotate {
    ...
    fun inDownLeft(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
    ...
    fun inDownRight(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
    ...
    fun inUpLeft(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val x = view.paddingLeft.toFloat()
        val y = view.height - view.paddingBottom.toFloat()
        val object1: ObjectAnimator = ObjectAnimator.ofFloat(view, "rotation", 90f, 0f)
        val object2: ObjectAnimator = ObjectAnimator.ofFloat(view, "alpha", 0f, 1f)
    ...
    fun inUpRight(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val x = (view.width - view.paddingRight).toFloat()
        val y = (view.height - view.paddingBottom).toFloat()
        val object1: ObjectAnimator = ObjectAnimator.ofFloat(view, "rotation", -90f, 0f)
        val object2: ObjectAnimator = ObjectAnimator.ofFloat(view, "alpha", 0f, 1f)
    ...
    fun outDownLeft(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val x = view.paddingLeft.toFloat()
        val y = (view.height - view.paddingBottom).toFloat()
        val object1: ObjectAnimator = ObjectAnimator.ofFloat(view, "alpha", 1f, 0f)
    ...
    fun outDownRight(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val x = (view.width - view.paddingRight).toFloat()
        val y = (view.height - view.paddingBottom).toFloat()
        val object1: ObjectAnimator = ObjectAnimator.ofFloat(view, "alpha", 1f, 0f)
        val object2: ObjectAnimator = ObjectAnimator.ofFloat(view, "rotation", 0f, -90f)
    ...
    fun outUpLeft(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val x = (view.paddingLeft).toFloat()
        val y = (view.height - view.paddingBottom).toFloat()
        val object1: ObjectAnimator = ObjectAnimator.ofFloat(view, "alpha", 1f, 0f)
        val object2: ObjectAnimator = ObjectAnimator.ofFloat(view, "rotation", 0f, -90f)
    ...
    fun outUpRight(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val x = (view.width - view.paddingRight).toFloat()
        val y = (view.height - view.paddingBottom).toFloat()
