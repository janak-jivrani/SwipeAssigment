...
object Attention {
    ...
    fun bounce(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val object1: ObjectAnimator =
            ObjectAnimator.ofFloat(view, "translationY", 0f, 0f, -30f, 0f, -15f, 0f, 0f)
        if (repeat) object1.repeatAnim()
        animatorSet.playTogether(object1)
        return animatorSet
    }

    fun flash(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
    ...
    fun pulse(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
    ...
    fun ruberBand(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val object1: ObjectAnimator =
    ...
    fun shake(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val object1: ObjectAnimator =
            ObjectAnimator.ofFloat(view, "scaleX", 1f, 1.25f, 0.75f, 1.15f, 1f)
        val object2: ObjectAnimator =
            ObjectAnimator.ofFloat(view, "scaleY", 1f, 0.75f, 1.25f, 0.85f, 1f)
    ...
    fun standUp(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val x =
    ...
    fun swing(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val object1: ObjectAnimator =
    ...
    fun taDa(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
    ...
    fun wave(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
        val x =
            ((view.width - view.paddingLeft - view.paddingRight) / 2 + view.paddingLeft).toFloat()
        val y = (view.height - view.paddingBottom).toFloat()
        val object1: ObjectAnimator =
    ...
    fun wobble(view: View, animatorSet: AnimatorSet, repeat: Boolean = false): AnimatorSet {
